...
import {jumlahKamiLevels} from '../../../../../src/data/berapakahjumlahkami';
import {saveGameProgress} from '../../../../../src/services/gameProgress';
import {refreshHeart, decrementHeart} from '../../../../../src/services/heartRegen';
import useBerapakahJumlahKami from '../../../../../src/hooks/useBerapakahJumlahKami';
...
export default function JumlahKamiLevel() {
  ...
  const currentAnswer = level.questions[questionIndex].answer;
  ...
  const {
    ...
    check,
    isFilled,
  } = useBerapakahJumlahKami(currentAnswer);
